...
import { ShoppingCart, ChevronDown, LogOut, Search } from "lucide-react";
        ...
        <>
            ...
            <nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-blue-300 via-blue-200 to-blue-100 shadow-md z-50 px-6 md:px-10 py-3">
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    {/* Thanh tìm kiếm phụ tùng - sát logo, nền trắng */}
                    <form
                        onSubmit={handleSearch}
                        className="flex-1 max-w-xs ml-2 mr-4 flex relative"
                        style={{ minWidth: 180 }}
                    >
                        <input
                            type="text"
