...
import { Bike, Tag, Palette, Building2, User, Save, ArrowLeft, Edit2 } from "lucide-react";
            ...
            <div className="bg-gradient-to-r from-amber-400 via-amber-500 to-orange-400 text-white">
                <div className="max-w-3xl mx-auto px-4 py-8">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h1 className="text-3xl font-bold mb-1">Chỉnh Sửa Xe Máy</h1>
                        <p className="text-white/80 text-sm font-mono text-lg">{licensePlate}</p>
                    </div>
                </div>
            </div>
