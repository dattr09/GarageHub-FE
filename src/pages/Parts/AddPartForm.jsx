...
import { Save, XCircle, Package, DollarSign, Layers, Tag, Archive, Image } from "lucide-react"; // Import các icon cần thiết
...
const AddPartForm = () => {
    ...
    useEffect(() => {
        const fetchBrands = async () => {
            try {
                const data = await getAllBrands(); // Gọi API lấy danh sách thương hiệu
                setBrands(data);
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                ...
                text: "Phụ tùng đã được thêm vào danh sách.",
                icon: "success",
        ...
        <div className="fixed inset-0 bg-black/40 z-40 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 w-full max-w-4xl">
                <div className="flex flex-col items-center justify-center px-6 py-4 border-b border-gray-100">
                    ...
                    <h3 className="text-2xl font-semibold text-gray-800 text-center">Thêm phụ tùng</h3>
                </div>
