...
const PartsList = () => {
  ...
  const handleAddToCart = (part) => {
    ...
    const idx = cart.findIndex(
      (item) => item.id === (part.id || part._id || part.name)
    );
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg shadow-md max-w-6xl mx-auto mt-6">
      ...
      <div className="flex justify-end mb-6 space-x-4">
        ...
        <button
          className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-md flex items-center gap-2"
          onClick={() => navigate("/parts/deleted/list")}
        >
          <Tag className="w-5 h-5" /> Quản lý xóa mềm
        </button>
      </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                ...
                <span className="font-semibold">
                  {part.brandId?.name || "Không xác định"}
                </span>
              </p>
            </div>
