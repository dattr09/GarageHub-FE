...
import { PlusCircle, ClipboardList, Eye, Edit } from "lucide-react";
...
export default function RepairOrderList() {
    ...
    const filteredOrders = orders.filter(o => {
        ...
        const dateStr = new Date(o.createdAt).toISOString().slice(0, 10); // yyyy-mm-dd
        ...
        <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg shadow-md max-w-6xl mx-auto mt-6">
            ...
            <div className="flex flex-col items-center mb-6">
                <div className="flex items-center gap-2 text-blue-600">
                    ...
                    <h2 className="text-3xl font-bold text-blue-800">Danh sách phiếu sửa chữa</h2>
                </div>
            </div>
